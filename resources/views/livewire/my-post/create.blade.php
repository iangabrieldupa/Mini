<div>
    <h1 class="text-white text-center offset-5">Create Post</h1>
    <div class="card offset-6 mt-5" id="post-create">
    ...
    @endif
        <div class="card-header" style="background-color:rgb(255, 234, 0);">
            <h5 class="text-center mt-3">Select Genre</h5>
        ...
        <div class="card-body">
            ...
            @error('remarks')
                <p class="text-danger text-center">{{ $message }}</p>
            @enderror
        <button class="btn" style="background-color:rgb(255, 234, 0);" wire:click="addPost()">Post</button>
    </div>
</div>
