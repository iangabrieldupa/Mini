<nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background-color: orange;">
    @role('writer')
    <a href="/" style="text-decoration: none; color: black; font-size: 30px; font-weight:800"><span style="color:red">AEON</span><span style="color:blue">ime</span></a>
    @endrole
    @role('admin')
    <a href="/admin" style="text-decoration: none; color: black; font-size: 30px; font-weight:800"><span style="color:red">AEON</span><span style="color:blue">ime</span></a>
    @endrole
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <div class="dropdown" style="margin-right: 60px;">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="select3" style="background-color: orange;">
                    @if (Auth::check())
...
<style>
  ...
  #hover-nav:hover {
    border-bottom: 3px solid rgb(228, 216, 83);
  }
  #hover-drop {
    padding: 10px;
  }
  #hover-drop:hover {
    background-color:rgb(228, 216, 83);
  }
  .active {
    background-color:rgb(228, 216, 83);
  }
